...
export function createTransferredPayout(overrides?: Partial<RevenuePayoutRow>): RevenuePayoutRow {
  return {
    ...
    explorer_url: "https://sepolia.basescan.org/tx/0x" + "b".repeat(64),
    transfer_keeper_hub_run_id: "exec_xfer_1",
    transfer_explorer_url: "https://sepolia.basescan.org/tx/0x" + "a".repeat(64),
    status: "transferred",
...
export function createActiveSponsoredWatch(
  ...
  return {
    ...
    create_explorer_url: "https://sepolia.basescan.org/tx/0x" + "d".repeat(64),
...
export function createCompletedSponsoredWatch(
  ...
  return {
    ...
    create_explorer_url: "https://sepolia.basescan.org/tx/0x" + "f".repeat(64),
    report_keeper_hub_run_id: "exec_watch_report",
    report_explorer_url: "https://sepolia.basescan.org/tx/0x" + "a1".repeat(32),
    on_chain_watch_id: 2,
