...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Every digest and public alert generated by ChronicleAI is anchored to the Ethereum Sepolia testnet. The agent writes proof-of-publication hashes to the Chronicle Registry contract. You can view the transaction receipt for any publication as a direct link to the block explorer.",
  },
  {
